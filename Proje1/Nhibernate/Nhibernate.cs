    ...
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "deneme_database");
        ...
        public static void Setup()
        {
            ...
            try
            {
                ...
                var mapping = GetMappings();
                NhConfiguration.AddDeserializedMapping(mapping, "deneme_database");
        ...
        {
            //log.Warn("Check DB");
            if (System.IO.File.Exists(exctLcl + "\\deneme_database.db")) return;
            SQLiteConnection.CreateFile(exctLcl + "\\deneme_database.db");
            using (var cn = new SQLiteConnection("Data Source=" + exctLcl + "\\deneme_database.db;Version=3;Password=;PRAGMA journal_mode=WAL;"))
            {
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=" + exctLcl + "//deneme_database.db;Version=3;PRAGMA journal_mode=WAL;";
            });
